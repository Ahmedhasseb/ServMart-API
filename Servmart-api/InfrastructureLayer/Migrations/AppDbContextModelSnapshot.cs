            ...
            modelBuilder.Entity("Domain_Layer.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("e8848de8-714a-4e80-a982-6baf45c4dd7b"),
                            Catagory = "ملابس "
                        },
                        new
                        {
                            ID = new Guid("ba563a74-1edd-4817-b724-a826e1c2dbff"),
                            Catagory = "الاغذية"
                        },
                        new
                        {
                            ID = new Guid("14dc9d55-0ef8-41ee-9e28-7fe9d6b3aac2"),
                            Catagory = "الآلكترونيات"
                        },
                        new
                        {
                            ID = new Guid("48f25c1c-c53e-4557-9f22-7112f2959fb1"),
                            Catagory = "الاجهزة المنزلية  "
                        },
                        new
                        {
                            ID = new Guid("a4eb2d10-4afc-47e7-97e4-06f8587a339e"),
                            Catagory = "المشروبات  "
                        },
                        new
                        {
                            ID = new Guid("a74c5106-042a-4993-bfe4-b44dceeb3718"),
                            Catagory = "العناية المنزلية  "
                        },
                        new
                        {
                            ID = new Guid("60e85931-a8ac-4956-a707-39b432a4e4d3"),
                            Catagory = " منتجات الاطفال"
                        },
                        new
                        {
                            ID = new Guid("f7bd66a0-e364-4847-9e6a-2c8426ba32b7"),
                            Catagory = "مستلزمات المنزل   "
                        },
                        new
                        {
                            ID = new Guid("8630e49a-afb0-466f-97b7-5bbe284e10f8"),
                            Catagory = "كتب   "
                        },
                        new
                        {
                            ID = new Guid("46e46759-0060-47ee-bdb2-ecb518e00a88"),
                            Catagory = "مستلزمات السيارات  "
                        },
                        new
                        {
                            ID = new Guid("0d6a415a-ea2e-474b-aa6a-10aa1fd8f871"),
                            Catagory = "العاب فيديو  "
                        });
                });
            ...
            modelBuilder.Entity("Domain_Layer.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("e70c9dda-fcf6-4d43-8439-c58196f78074"),
                            NameAr = "المحاسبة",
                            NameEn = "Accounting"
                        },
                        new
                        {
                            ID = new Guid("5893bf87-6500-418a-80bb-753214bb37b8"),
                            NameAr = "الإعلان والتسويق",
                            NameEn = "Advertising and marketing"
                        },
                        new
                        {
                            ID = new Guid("4da7dc08-5ce4-4204-9a2a-f6c9f729b2fa"),
                            NameAr = "إستشارات",
                            NameEn = "Consulting "
                        },
                        new
                        {
                            ID = new Guid("59a5bb14-adc2-471e-9995-efe551a51170"),
                            NameAr = "خدمات تكنولوجيا المعلومات",
                            NameEn = "Information technology services"
                        },
                        new
                        {
                            ID = new Guid("4880d7a4-0b22-467b-8d2d-75738b2e5cd8"),
                            NameAr = "خدمات قانونية",
                            NameEn = "Legal services"
                        },
                        new
                        {
                            ID = new Guid("e87ef9ec-e4b0-4c47-952c-6413d19851ed"),
                            NameAr = "إدارة المكاتب",
                            NameEn = "Office management"
                        },
                        new
                        {
                            ID = new Guid("323463a4-26f0-43f5-b90f-e9e9cc9c1da1"),
                            NameAr = "خدمات الترجمة",
                            NameEn = "Translation services"
                        },
                        new
                        {
                            ID = new Guid("d5527b2f-553d-4bef-9e48-ed50d1cd4a56"),
                            NameAr = "تصميم وتطوير مواقع الويب",
                            NameEn = "Web design and development"
                        },
                        new
                        {
                            ID = new Guid("25fffb1a-e7d2-40c6-862a-e1a497732901"),
                            NameAr = "صيانة سيارات",
                            NameEn = "Car maintenance"
                        },
                        new
                        {
                            ID = new Guid("16cfb998-a18a-4568-af51-49156111120d"),
                            NameAr = "خدمات التجميل",
                            NameEn = "Beauty services"
                        },
                        new
                        {
                            ID = new Guid("f05a33d9-5e75-42c1-9d9f-4a48db41e1a5"),
                            NameAr = "تقديم الطعام",
                            NameEn = "Catering "
                        },
                        new
                        {
                            ID = new Guid("13add710-ac37-4f33-b4e8-2e7fcaa17c6d"),
                            NameAr = "رعاية الأطفال",
                            NameEn = "Childcare"
                        },
                        new
                        {
                            ID = new Guid("50493ecd-93bc-4b82-a3bb-f91253c1a021"),
                            NameAr = "خدمات التنظيف",
                            NameEn = "Cleaning services"
                        },
                        new
                        {
                            ID = new Guid("8fc6e93d-50cf-474b-a412-52df6f3b6e93"),
                            NameAr = "إصلاح الكمبيوتر",
                            NameEn = "Computer repair"
                        },
                        new
                        {
                            ID = new Guid("6dc00977-2f4f-4a23-bcb7-3939b9d00d5f"),
                            NameAr = "خدمات التوصيل",
                            NameEn = "Delivery services"
                        },
                        new
                        {
                            ID = new Guid("6ebf643f-4c64-4269-869e-39493b701613"),
                            NameAr = "التنظيف الجاف",
                            NameEn = "Dry cleaning"
                        },
                        new
                        {
                            ID = new Guid("d8723a1d-98da-4f73-b3c2-734193534461"),
                            NameAr = "التخطيط للأحداث",
                            NameEn = "Event planning"
                        },
                        new
                        {
                            ID = new Guid("2ebbb417-fbd6-4433-a35e-a720cbb43b7a"),
                            NameAr = "الخدمات المالية",
                            NameEn = "Financial services"
                        },
                        new
                        {
                            ID = new Guid("87dff1d9-aa27-4bb5-b2ee-990a637b6273"),
                            NameAr = "تدريب اللياقة البدنية",
                            NameEn = "Fitness training"
                        },
                        new
                        {
                            ID = new Guid("8e1f0cc3-ce3f-4500-a567-c2f0e3fdf7e3"),
                            NameAr = "توصيل طلبات الطعام",
                            NameEn = "Food delivery"
                        },
                        new
                        {
                            ID = new Guid("8e997bca-4666-482c-89f6-f0140107569a"),
                            NameAr = "تأمين",
                            NameEn = "Insurance"
                        },
                        new
                        {
                            ID = new Guid("96521463-267b-40dd-a15e-9a1fa9d074b0"),
                            NameAr = "العناية بالحديقة",
                            NameEn = "Garden care"
                        },
                        new
                        {
                            ID = new Guid("e2789d22-c668-4407-8953-fa37c1469086"),
                            NameAr = "خدمات غسيل الملابس",
                            NameEn = "Laundry services"
                        },
                        new
                        {
                            ID = new Guid("9bf93beb-d23f-456a-bc39-a7cd03add2fb"),
                            NameAr = "خدمات صناعة الأقفال",
                            NameEn = "Locksmith services"
                        },
                        new
                        {
                            ID = new Guid("7a5cb5d5-6e71-41b3-b29f-3887db7c6672"),
                            NameAr = "الخدمات الطبية",
                            NameEn = "Medical services"
                        },
                        new
                        {
                            ID = new Guid("787f5c20-736d-40a0-8c1d-98b5921a8350"),
                            NameAr = "خدمات النقل",
                            NameEn = "Transportation services"
                        },
                        new
                        {
                            ID = new Guid("23a4dcc0-c2f5-43ae-9c51-6493bd6576ee"),
                            NameAr = "رعاية الحيوانات الاليفة",
                            NameEn = "Pet care"
                        },
                        new
                        {
                            ID = new Guid("f6acf4d2-cd8a-4b64-8837-5d179cf623ab"),
                            NameAr = "الخدمات البيطرية",
                            NameEn = "Veterinary services"
                        },
                        new
                        {
                            ID = new Guid("270dc038-a3ad-4824-ae3e-1a92cf47b9c4"),
                            NameAr = "سباكة",
                            NameEn = "Plumbing"
                        },
                        new
                        {
                            ID = new Guid("d7c567f3-a8cd-432a-a88a-1f46da93ceff"),
                            NameAr = "كهرباء",
                            NameEn = "Electricity"
                        },
                        new
                        {
                            ID = new Guid("9e92cb31-df62-42b8-802a-33ff669ab4b7"),
                            NameAr = "نجارة",
                            NameEn = "Carpenter "
                        },
                        new
                        {
                            ID = new Guid("28f99b0c-7f08-4de4-9e92-4bea16f9aaab"),
                            NameAr = "نقاشة",
                            NameEn = "Painter"
                        },
                        new
                        {
                            ID = new Guid("9d8285d5-7d16-4c72-ba3a-d0b5ca393149"),
                            NameAr = "مكافحة الحشرات والطيور",
                            NameEn = "Pest and bird control"
                        },
                        new
                        {
                            ID = new Guid("7cec067e-17f2-425f-a6b4-4398bdbc1fac"),
                            NameAr = "ساتلايت ورسيفر",
                            NameEn = "Satellite and receiver"
                        },
                        new
                        {
                            ID = new Guid("87cab33a-be45-4590-b10a-5b55d10741a5"),
                            NameAr = "التكييف",
                            NameEn = "Air conditioning"
                        },
                        new
                        {
                            ID = new Guid("8b6e8c13-857f-4b6e-a3c7-88275b48f5ea"),
                            NameAr = "تركيب و صيانة الاجهزة المنزلية",
                            NameEn = "Installation and maintenance of home appliances"
                        },
                        new
                        {
                            ID = new Guid("36c4fe59-20ed-45be-968e-f76720a07f14"),
                            NameAr = "تنظيف حمام السباحة",
                            NameEn = "Swimming pool cleaning"
                        },
                        new
                        {
                            ID = new Guid("9c22e75c-4e94-461c-b76f-53053c8d1499"),
                            NameAr = "تسقيف",
                            NameEn = "Roofing"
                        },
                        new
                        {
                            ID = new Guid("3f1c75b2-df64-4f53-a03d-78f165777c11"),
                            NameAr = "خدمات سيارات الأجرة",
                            NameEn = "Taxi services"
                        },
                        new
                        {
                            ID = new Guid("d0de0255-9042-4455-8a25-8ff070fe7aba"),
                            NameAr = "خدمات حكومية",
                            NameEn = "Government services"
                        },
                        new
                        {
                            ID = new Guid("f4b56f01-cbd5-4d6a-9014-36cd94c70e71"),
                            NameAr = "المكتبات",
                            NameEn = "Libraries"
                        },
                        new
                        {
                            ID = new Guid("e50c1f9f-f4e9-4b9b-bb7e-395522196d6f"),
                            NameAr = "حدائق و منتجعات ترفيهيه",
                            NameEn = "Parks and recreation"
                        },
                        new
                        {
                            ID = new Guid("9b2e53d9-8959-46e1-a38e-aad38150787b"),
                            NameAr = "ترفيه",
                            NameEn = "Entertainment"
                        },
                        new
                        {
                            ID = new Guid("d30ad13a-f6ef-4b51-8172-515d1dc3ad38"),
                            NameAr = "ضيافة",
                            NameEn = "Hospitality"
                        },
                        new
                        {
                            ID = new Guid("963f8360-caa3-4641-9727-b4dd62b96bb5"),
                            NameAr = "العقارات",
                            NameEn = "Real estate"
                        },
                        new
                        {
                            ID = new Guid("2752b06b-a012-4266-a771-02a968bd7396"),
                            NameAr = "الرياضة",
                            NameEn = "Sports"
                        },
                        new
                        {
                            ID = new Guid("55dae3ea-a1df-4874-83a0-44adb25c0e0d"),
                            NameAr = "البناء",
                            NameEn = "Construction"
                        },
                        new
                        {
                            ID = new Guid("50ff647f-22c0-4367-b688-db911820688d"),
                            NameAr = "خدمات أخرى",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "bf68199a-554d-4219-adba-70011bc4e93c",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "0e9f6806-5417-4496-b96a-bc4f25157e02",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "2f4dc293-fbc7-46e9-98a3-52aa429c2278",
                            Name = "Vendor",
                            NormalizedName = "VENDOR"
                        },
                        new
                        {
                            Id = "d670b6e8-d816-461f-9b82-e96e4b3228b0",
